...
public class ResultBuilder {
    ...
    private int totalMutants = Integer.MIN_VALUE;
    ...
    public void logPitest(CombinedStatistics stats) {
        ...
        // The number of total mutants has been overridden by the teacher and has priority
        if (this.totalMutants != Integer.MIN_VALUE) {
            totalMutations = this.totalMutants;
        } else {
            // Otherwise we take the number of total mutations generated by Pitest
