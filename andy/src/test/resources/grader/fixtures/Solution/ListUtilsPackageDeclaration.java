...
package delft;import static org.assertj.core.api.Assertions.*;
...
class ListUtilsTest {
    ...
    // In this example test class, there is no compilation failure.
    // The report should inform the student that the compilation was successful.
